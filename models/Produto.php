...
class Produto {
    ...
    public function salvar($dados) {
        ...
        if(empty($dados["id"])) {
            $sql = "insert into produto (id, nome, categoria_id, descricao, autor, valor, destaque, ativo, imagem)
            values (NULL, :nome, :categoria_id, :descricao, :autor, :valor, :destaque, :ativo, :imagem)";
            $consulta = $this->pdo->prepare($sql);
            ...
            //atualizar produto
            $sql = "update produto set nome = :nome, categoria_id = :categoria_id, autor = :autor,
